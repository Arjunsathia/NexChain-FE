...
function FeedbackDetailsModal({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`px-4 py-3 sm:p-6 flex justify-between items-center bg-gradient-to-r ${TC.headerGradient} bg-opacity-10`}
        >
          ...
          <button
            ...
            className={`transition-all duration-300 p-2 rounded-xl group hover:scale-110 ${
              isLight
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-h-[70vh] overflow-y-auto no-scrollbar">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div className={`p-4 rounded-xl border ${TC.bgItem}`}>
              <p
                className={`text-[10px] sm:text-xs uppercase font-bold tracking-wider mb-2 ${TC.textSecondary}`}
              >
                User Account
              </p>
              <div className="flex items-center gap-3">
                ...
                <p
                  className={`text-xs sm:text-base font-bold ${TC.textPrimary}`}
                >
          ...
          <div
            className={`p-5 rounded-2xl border ${TC.bgItem} relative overflow-hidden group`}
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/5 blur-3xl rounded-full" />
            <p
              className={`text-[10px] sm:text-xs uppercase font-bold tracking-wider mb-3 ${TC.textSecondary}`}
            >
              Feedback Message
            </p>
            <p
              className={`text-sm sm:text-base leading-relaxed ${TC.textPrimary} relative z-10`}
            >
        ...
        <div
          className={`px-4 py-3 sm:p-6 flex justify-end gap-3 border-t ${isLight ? "border-gray-100" : "border-white/5"}`}
        >
          <button
            onClick={() => setShowModal(false)}
