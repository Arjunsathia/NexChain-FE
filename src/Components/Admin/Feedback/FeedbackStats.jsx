...
function FeedbackStats({ stats, TC }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
      {[
        { label: "Total", value: stats.total || 0, icon: FaChartBar, color: "from-blue-500 to-cyan-500" },
        { label: "Today", value: stats.today || 0, icon: FaCalendarDay, color: "from-indigo-500 to-blue-500" },
        { label: "In Progress", value: stats.inProgress || 0, icon: FaLightbulb, color: "from-amber-500 to-orange-500" },
        { label: "Resolved", value: stats.resolved || 0, icon: FaCheckCircle, color: "from-emerald-500 to-green-500" },
      ].map((stat, i) => (
        <div
          key={i}
