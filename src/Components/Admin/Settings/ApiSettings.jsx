          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                readOnly
                className={`flex-1 rounded-xl px-3 sm:px-4 py-2 sm:py-2.5 text-sm outline-none border ${TC.bgInput}`}
              />
              <button
                className={`px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-bold ${TC.btnPrimary}`}
              >
                Regenerate
              </button>
            </div>
