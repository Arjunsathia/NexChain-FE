...
const TC = {
    ...
    btnSubmit: "bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white",
    btnCancel: "border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
};
            ...
            <Dialog as="div" className="relative z-[1000000]" onClose={handleClose}>
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <DialogPanel className={`w-full max-w-md transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all ${isLight ? 'bg-white' : 'bg-[#0f172a] border border-white/10'}`}>
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="p-3 rounded-full bg-cyan-500/10">
                                        <ShieldCheck className="w-6 h-6 text-cyan-500" />
                                    </div>
                                    <div>
                                        <DialogTitle as="h3" className={`text-lg font-bold ${TC.textTitle}`}>
                                            Security Verification
                                        </DialogTitle>
                                        <p className="text-sm text-gray-500">Admin privileges required</p>
                                    </div>
                                    <button onClick={handleClose} className="ml-auto text-gray-400 hover:text-gray-500">
                                        <X className="w-5 h-5" />
                                    </button>
                                </div>
                                ...
                                <div className="mt-2">
                                    <p className={`text-sm ${TC.textDesc}`}>
                                        This action requires 2-Step Verification. Please enter the code from your Authenticator app.
                                    </p>
                                </div>
