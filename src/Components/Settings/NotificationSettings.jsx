        ...
        {[
          {
            id: "emailAlerts",
            label: "Email Alerts",
            desc: "Receive market updates & newsletters via email",
          },
          {
            id: "pushNotifications",
            label: "Push Notifications",
            desc: "Get instant alerts for your trades & security",
          },
          {
            id: "securityAlerts",
            label: "Security Alerts",
            desc: "Immediate notifications for suspicious login attempts",
          },
        ].map((item) => (
          <div
            key={item.id}
            className={`rounded-xl p-5 border flex items-center justify-between gap-4 transition-all ${TC.bgItem}`}
          >
            <div>
              <h3
              ...
              <p
                className={`text-[10px] sm:text-xs font-medium ${TC.textSecondary} mt-1`}
              >
                {item.desc}
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer shrink-0">
              ...
              />
              <div
                className={`w-11 h-6 rounded-full peer peer-focus:ring-2 peer-focus:ring-cyan-500/20 transition-all 
