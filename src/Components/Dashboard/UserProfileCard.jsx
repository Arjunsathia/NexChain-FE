    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3
            className={`font-bold text-base truncate ${isLight ? "text-gray-900" : "text-white"}`}
          >
      ...
      {}
      <div
        className={`mt-4 pt-3 border-t ${isLight ? "border-gray-200" : "border-gray-700"}`}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 opacity-80">
            <div
              className={`p-1.5 rounded-lg ${isLight ? "bg-cyan-100 text-cyan-600" : "bg-cyan-400/10 text-cyan-400"}`}
            >
              <FaWallet className="text-xs" />
            </div>
            <span
              className={`text-xs font-medium ${isLight ? "text-gray-500" : "text-gray-400"}`}
            >
              Available Balance
            </span>
          </div>
