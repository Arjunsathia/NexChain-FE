...
function CryptoTrendingCoins() {
  ...
  return (
    <div
      className={`rounded-xl p-4 md:p-5 fade-in ${TC.bgContainer} h-full flex flex-col`}
      style={{ animationDelay: "0.1s" }}
    >
      <h2
        className={`text-sm md:text-base font-bold mb-3 ${TC.textPrimary} fade-in flex items-center gap-2`}
      ...
      {loading ? (
        ...
        <div
          className={`text-center mt-4 flex flex-col items-center justify-center gap-2 fade-in ${TC.textError}`}
