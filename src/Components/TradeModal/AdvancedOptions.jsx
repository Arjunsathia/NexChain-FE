  ...
  return (
    <div className="mt-4">
      ...
      >
        ...
        <FaChevronRight
          className={`ml-auto text-[10px] transition-transform ${isOpen ? "rotate-90" : ""}`}
        />
      </button>
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              <span
                className={`text-xs font-medium ${isLight ? "text-gray-700" : "text-gray-200"}`}
              >
                Slippage Tolerance
              </span>
              <span
            ...
            >
              <input
                ...
                className={`w-12 text-right bg-transparent outline-none text-sm font-mono font-bold ${
