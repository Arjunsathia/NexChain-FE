          ...
          >
            ...
            <div className="bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-bold text-lg">Learning Assistant</h3>
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className={`text-xs mt-1 ${message.sender === 'user' ? 'text-white/70' : isLight ? 'text-gray-500' : 'text-gray-400'}`}>
