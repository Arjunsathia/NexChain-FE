...
const featuresList = [
  {
    ...
    description: "Real-time charting with 100+ indicators and AI-driven pattern recognition.",
    icon: BarChart3
  },
  {
    id: 1,
  ...
  },
  {
    ...
    description: "Trade with confidence using our ultra-low latency matching engine.",
    icon: Zap
  },
  {
    id: 3,
    title: "Cross-Platform",
    description: "Seamlessly sync your portfolio across desktop, mobile, and tablet devices.",
    icon: Layout
  },
];
...
const WaveConnection = ({ activeIndex }) => {
  ...
  return (
    <svg className="w-full h-full overflow-visible" viewBox={`0 0 100 ${TOTAL_HEIGHT}`} preserveAspectRatio="none">
      <defs>
      ...
      {featuresList.map((_, index) => {
        ...
        return (
          <path
            ...
            fill="none"
            stroke={isSelected ? "url(#waveGradient)" : "rgba(255, 255, 255, 0.05)"}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-10">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-white font-manrope">
            Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4fcdda] via-[#364abe] to-[#233784] filter drop-shadow-[0_0_20px_rgba(79,205,218,0.4)]">NexChain</span>?
          </h2>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto font-light">
            We combine institutional-grade tools with an intuitive interface to give you the trade advantage.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-5 w-full">
                    ...
                    {/* Text */}
                    <div>
                      <h3 className={`text-lg font-bold font-manrope transition-colors ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-slate-200'}`}>
                        {feature.title}
                      </h3>
                      <p className={`text-sm mt-1 leading-relaxed transition-colors ${isActive ? 'text-cyan-100/80 font-medium' : 'text-slate-500'}`}>
                        {feature.description}
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  ">
                    {React.createElement(featuresList[activeFeature].icon, {
                      className: "w-10 h-10 text-cyan-400 relative z-10 drop-shadow-[0_0_10px_rgba(79,205,218,0.5)]"
                    })}
                  </div>
