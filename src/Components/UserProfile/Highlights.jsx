...
function Highlights() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-0 right-0 w-64 h-64 bg-orange-500/5 rounded-full blur-3xl -mr-32 -mt-32 pointer-events-none transition-opacity duration-500 ${isLight ? "opacity-100" : "opacity-20"}`}
      />
          ...
          {topGainers.map((coin, index) => (
            ...
            >
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <span className={`text-xs font-bold w-4 ${TC.textTertiary}`}>
                  #{index + 1}
                </span>
                <img
                  src={coin?.image}
              ...
              <div className="text-right shrink-0">
                <div
                  className={`flex items-center justify-end gap-1 font-bold text-[10px] px-1.5 py-0.5 rounded-md mb-0.5 w-fit ml-auto ${TC.bgValue}`}
                >
