  ...
  return (
    <main className="min-h-screen text-white font-sans selection:bg-cyan-500/30">
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="hidden lg:block w-72 sticky top-0 h-screen flex-shrink-0 p-4 z-50">
              ...
              {isLoading ? (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 h-80">
                      <div className="animate-pulse">
